<nav>
    <ul class="main-nav">
        <li class="<?php echo isset($pageName) && $pageName == "index" ?  "active" :  ""; ?>"><a href="index.php">Home</a></li>
        <li class="dropdown">
        ...
        <li class="<?php echo isset($pageName) && $pageName == "contact" ? "active" : "" ?>"><a href="contactus.php">Contact Us</a></li>
        <li class="<?php echo isset($pageName) && $pageName == "about" ? "active" : "" ?>"><a href="about.php">About us</a></li>
        <?php
        // Start a Session
    ...
    if (isset($_SESSION['username'])) {
        ...
        echo "        <li class=\"" . (isset($pageName) && $pageName == "login" ? "active" : "") . "\"><a href=\"login.php\">Login</a></li>";
        echo "        <li class=\"" . (isset($pageName) && $pageName == "register" ? "active" : "") . "\"><a href=\"register.php\">Register</a></li>";
        echo "</ul>";
    }
    ?>
